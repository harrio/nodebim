...
/***/ function(module, exports, __webpack_require__) {
	...
	var onVRWindowResize = function onVRWindowResize() {
	  var width = window.innerWidth;
	  var height = window.innerHeight;
	  resizeWindow(width, height);
	};
	
	var resizeWindow = function resizeWindow(width, height) {
	...
	var getIntersectedMenu = function getIntersectedMenu() {
	  ...
	  var intersects = menuParent ? raycaster.intersectObjects(menuParent.children.concat(toggleParent.children)) : raycaster.intersectObjects(toggleParent.children);
	...
	var loadModel = function loadModel(name) {
	  BimManager.loadModelToScene(name, scene, function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.toggleMaterial = exports.getMaterials = exports.getObject = exports.getEnvironment = exports.loadEnvironment = exports.loadModelToScene = undefined;
	...
	var addObject = function addObject(scene, callback) {
	...
	var loadModelToScene = function loadModelToScene(name, scene, callback) {
	  objMaterials = {};
	  oldOpacities = {};
	  scene.remove(object);
	  // load a resource
	  loader.load(name, addObject(scene, callback));
	};
	...
	var getMaterials = function getMaterials() {
	  return objMaterials;
	};
	
	var toggleMaterial = function toggleMaterial(materialHolder) {
	  var material = materialHolder.material;
	...
	exports.toggleMaterial = toggleMaterial;
...
/***/ function(module, exports) {
	...
	var menuParent = void 0,
	    menuToggle = void 0,
	    toggleParent = void 0;
	
	var createMenuToggle = function createMenuToggle(dolly) {
	  toggleParent = new THREE.Object3D();
	  var geometry = new THREE.CylinderGeometry(0, 0.05, 0.05, 8);
	...
	var createMenu = function createMenu(dolly, camera, materials) {
	...
	var hideMenu = function hideMenu(dolly) {
	  dolly.remove(menuParent);
	};
	
	var updateMenuPosition = function updateMenuPosition(camera, menu) {
	  if (menu) {
	...
	exports.createMenuToggle = createMenuToggle;
